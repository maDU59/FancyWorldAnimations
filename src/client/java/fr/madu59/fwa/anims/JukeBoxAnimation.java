...
public class JukeBoxAnimation extends Animation{
    ...
    public void render(AnimationRenderingContext context) {
        ...
        Minecraft.getInstance().getItemModelResolver().updateForTopItem(discState, discItemStack, ItemDisplayContext.FIXED, Minecraft.getInstance().level, null, position.hashCode());
