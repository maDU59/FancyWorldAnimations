...
public class LanternAnimation extends Animation{
    ...
    private final List<BlockModelPart> chainParts = new ArrayList<>();
    ...
    public void render(AnimationRenderingContext context) {
        ...
        for (int index = chainCount - 1; index >= 1; --index) {
            ...
            RenderHelper.renderModel(buffer, poseStack.last(), chainParts, 1.0f, 1.0f, 1.0f, 1.0f, light, new AnimationBlockData(chainState, mutable, light));
            poseStack.popPose();
