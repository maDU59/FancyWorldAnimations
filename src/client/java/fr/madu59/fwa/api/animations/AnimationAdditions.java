...
public class AnimationAdditions {
    ...
    private static final Map<ResourceLocation, Type> additionalAnimations = new HashMap<>();
     ...
     * @since 1.2.26
     */
    public static void registerAnimationForBlock(ResourceLocation blockId, Type animationType){
     ...
     */
    @ApiStatus.Internal
    public static Map<ResourceLocation, Type> getAdditionalBlockAnimations(){
     ...
     */
    @ApiStatus.Internal
    public static boolean hasAnimation(ResourceLocation blockId){
     ...
     */
    @ApiStatus.Internal
    public static Type getAnimationType(ResourceLocation blockId){
