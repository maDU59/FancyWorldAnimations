...
import fr.madu59.fwa.config.configscreen.entries.builders.ButtonBuilder;
import fr.madu59.fwa.config.configscreen.entries.builders.CategoryBuilder;
import fr.madu59.fwa.config.configscreen.entries.builders.SliderBuilder;
    ...
    public static class ButtonEntry extends Entry{
        ...
        public boolean mouseClicked(MouseButtonEvent click, boolean doubleClick) {
            if (this.button.mouseClicked(click, doubleClick)) {
                ...
                if(this.option != null){
                    this.button.setMessage(Component.translatable(FancyWorldAnimations.MOD_ID + ".config.value." + this.option.getValue().toString().toLowerCase()));
                }
                return true;
            }
            return false;
